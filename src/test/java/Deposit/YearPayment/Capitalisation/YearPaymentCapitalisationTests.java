...
public class YearPaymentCapitalisationTests {
    ...
    public void typeDateYearCapitalisation1() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 1, Deposit.DepositCalculator.termSelect.year, 12, 0, true, LocalDate.of(2024, 1, 1), Deposit.DepositCalculator.termSelect.year);
    ...
    public void typeDateYearCapitalisation2() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 2, Deposit.DepositCalculator.termSelect.year, 12, 0, true, LocalDate.of(2024, 1, 1), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
    ...
    public void typeDateYearCapitalisation3() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 5, Deposit.DepositCalculator.termSelect.year, 12, 0, true, LocalDate.of(2024, 1, 1), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
...
//    }
    ...
    public void typeDateYearCapitalisation5() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000, 1, Deposit.DepositCalculator.termSelect.year, 10, 0, true, LocalDate.of(2024, 2, 29), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
    ...
    public void typeDateYearCapitalisation6() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 5, Deposit.DepositCalculator.termSelect.year, 12, 0, true, LocalDate.of(2024, 2, 29), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
    ...
    public void typeDateYearCapitalisation7() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000, 10, Deposit.DepositCalculator.termSelect.day, 10, 0, true, LocalDate.of(2024, 2, 29), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
    ...
    public void typeDateYearCapitalisation8() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000, 10, Deposit.DepositCalculator.termSelect.month, 10, 0, true, LocalDate.of(2024, 2, 29), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
    ...
    public void typeDateYearCapitalisation9() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000, 10, Deposit.DepositCalculator.termSelect.month, 10, 0, true, LocalDate.of(2024, 12, 29), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
    ...
    public void typeDateYearCapitalisation10() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 20, Deposit.DepositCalculator.termSelect.year, 12, 0, true, LocalDate.of(2024, 2, 29), Deposit.DepositCalculator.termSelect.year);
        DepositCalculator.calculate();
