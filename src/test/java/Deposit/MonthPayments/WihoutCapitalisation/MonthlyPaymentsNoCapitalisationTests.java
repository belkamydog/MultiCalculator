...
public class MonthlyPaymentsNoCapitalisationTests {
    ...
    public void DepositCalculatorNoCapitalisationMonth1() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 1, Deposit.DepositCalculator.termSelect.month, 12, 0, false, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
    ...
    public void DepositCalculatorNoCapitalisationMonth3() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 10, Deposit.DepositCalculator.termSelect.month, 12, 0, false, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth4() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 12, Deposit.DepositCalculator.termSelect.month, 12, 0, false, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth5() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 14, Deposit.DepositCalculator.termSelect.month, 12, 0, false, LocalDate.of(2024, 1,9), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth6() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 2, Deposit.DepositCalculator.termSelect.month, 12, 0, false, LocalDate.of(2024, 1,9), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth7() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 2, Deposit.DepositCalculator.termSelect.month, 12, 0, false, LocalDate.of(2024, 12,15), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth8() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 300, Deposit.DepositCalculator.termSelect.month, 6, 0, false, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth9() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000000, 600, Deposit.DepositCalculator.termSelect.month, 6, 0, false, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth10() {
        DepositCalculator DepositCalculator = new DepositCalculator(100000000, 600, Deposit.DepositCalculator.termSelect.month, 100, 0, false, LocalDate.of(2024, 12,12), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
