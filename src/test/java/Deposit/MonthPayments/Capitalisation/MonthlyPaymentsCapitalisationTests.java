...
public class MonthlyPaymentsCapitalisationTests {
    ...
    public void DepositCalculatorCapitalisationMonth1() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 1, Deposit.DepositCalculator.termSelect.month, 12, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
    ...
    public void DepositCalculatorCapitalisationMonth2() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 6, Deposit.DepositCalculator.termSelect.month, 12, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorCapitalisationMonth3() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 10, Deposit.DepositCalculator.termSelect.month, 12, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorCapitalisationMonth4() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 12, Deposit.DepositCalculator.termSelect.month, 12, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorNoCapitalisationMonth5() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 14, Deposit.DepositCalculator.termSelect.month, 12, 0, true, LocalDate.of(2024, 1,9), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorCapitalisationMonth6() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 2, Deposit.DepositCalculator.termSelect.month, 12, 0, true, LocalDate.of(2024, 1,9), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorCapitalisationMonth7() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 2, Deposit.DepositCalculator.termSelect.month, 12, 0, true, LocalDate.of(2024, 12,15), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorCapitalisationMonth8() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 300, Deposit.DepositCalculator.termSelect.month, 6, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorCapitalisationMonth9() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000000, 600, Deposit.DepositCalculator.termSelect.month, 6, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
    ...
    public void DepositCalculatorCapitalisationMonthIfTermLessThenMonth() {
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 15, Deposit.DepositCalculator.termSelect.day, 10, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.month);
        DepositCalculator.calculate();
