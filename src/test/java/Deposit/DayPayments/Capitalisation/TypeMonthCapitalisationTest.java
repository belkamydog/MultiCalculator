 ...
 * С капитализацией тип вводимой даты Deposit.DepositCalculator.termSelect.month
...
public class TypeMonthCapitalisationTest {
    ...
    void typeMonth1CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(1, 1,  Deposit.DepositCalculator.termSelect.month, 19, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.day);
    ...
    void typeMonth2CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(1000, 3, Deposit.DepositCalculator.termSelect.month, 100, 0, true, LocalDate.of(2024, 1,1), Deposit.DepositCalculator.termSelect.day);
        DepositCalculator.calculate();
    ...
    void typeMonth3CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(9999, 33, Deposit.DepositCalculator.termSelect.month, 11, 0, true, LocalDate.of(2024, 1,31), Deposit.DepositCalculator.termSelect.day);
        DepositCalculator.calculate();
    ...
    void typeMonth4CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(999999999, 33, Deposit.DepositCalculator.termSelect.month, 11, 0, true, LocalDate.of(2024, 12,31), Deposit.DepositCalculator.termSelect.day);
        DepositCalculator.calculate();
...
//        DepositCalculator DepositCalculator = new DepositCalculator(999999999, 600, Deposit.DepositCalculator.termSelect.month, 11, 0, true, LocalDate.of(2024, 12,31), Deposit.DepositCalculator.termSelect.day);
//        DepositCalculator.calculate();
...
//    }
    ...
    void typeMonth6CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(999999999, 1, Deposit.DepositCalculator.termSelect.month, 1, 0, true, LocalDate.of(2024, 7,31), Deposit.DepositCalculator.termSelect.day);
        DepositCalculator.calculate();
...
//        DepositCalculator DepositCalculator = new DepositCalculator(100000000, 600, Deposit.DepositCalculator.termSelect.month, 100, 0, true, LocalDate.of(2024, 9,22));
//        DepositCalculator.calculate();
