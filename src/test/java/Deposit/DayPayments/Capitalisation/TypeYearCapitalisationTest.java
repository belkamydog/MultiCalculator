 ...
 * С капитализацией. Тип вводимой даты "year".
...
public class TypeYearCapitalisationTest {
    ...
    void typeYear1CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(1, 1, "year", 19, 0, true, LocalDate.of(2024, 1,1), "day");
    ...
    void typeYear2CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 1, "year", 19, 0, true, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear3CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 1, "year", 100, 0, true, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear4CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 2, "year", 12, 0, true, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear5CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(100000, 2, "year", 100, 0, true, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear6CapitalTrue(){
        DepositCalculator DepositCalculator = new DepositCalculator(100000, 50, "year", 3, 0, true, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void changeStatTableBalanceTest(){
        DepositCalculator depositCalculator = new DepositCalculator(10000, 5, "year", 12, 0, true, LocalDate.of(2024, 1,1), "day");
        depositCalculator.calculate();
        depositCalculator.printStat();
    }
}
