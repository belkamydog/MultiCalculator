 ...
 * С капитализацией тип вводимой даты "day"
...
public class TypeDayCapitalisationTest {
    ...
    void typeDay2dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(1, 10, "day", 12, 0, true, LocalDate.of(2024, 3, 12), "day");
        DepositCalculator.calculate();
        Assertions.assertEquals(1, DepositCalculator.getResultDepositAmount());
        Assertions.assertEquals(0, DepositCalculator.getInterestCharges());
        Assertions.assertEquals(0, DepositCalculator.getCapitalGains());
    ...
    void typeDay3dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000, 10, "day", 12, 0, true, LocalDate.of(2024, 3, 12), "day");
        DepositCalculator.calculate();
    ...
    void typeDay4dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000, 1000, "day", 12, 0, true, LocalDate.of(2024, 6, 12), "day");
        DepositCalculator.calculate();
    ...
    void typeDay5dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(3333, 333, "day", 12, 0, true, LocalDate.of(2024, 6, 13), "day");
        DepositCalculator.calculate();
    ...
    void typeDay6dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 1500, "day", 12, 0, true, LocalDate.of(2024, 9, 22), "day");
        DepositCalculator.calculate();
    ...
    void typeDay9dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 1000, "day", 9.9, 0, true, LocalDate.of(2024, 12, 31), "day");
        DepositCalculator.calculate();
    ...
    void typeDay10dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 1000, "day", 0.1, 0, true, LocalDate.of(2024, 12, 31), "day");
        DepositCalculator.calculate();
    ...
    void typeDay11dayCapitalTrue() {
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 18250, "day", 12, 0, true, LocalDate.of(2024, 9, 22), "day");
        DepositCalculator.calculate();
