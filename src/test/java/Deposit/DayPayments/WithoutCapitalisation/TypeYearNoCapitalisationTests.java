 ...
 * Без капитализации тип вводимой даты "year"
...
public class TypeYearNoCapitalisationTests {
    ...
    void typeYear1CapitalFalse(){
        DepositCalculator DepositCalculator = new DepositCalculator(1, 1, "year", 19, 0, false, LocalDate.of(2024, 1,1), "day");
    ...
    void typeYear2CapitalFalse(){
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 1, "year", 19, 0, false, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear3CapitalFalse(){
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 1, "year", 100, 0, false, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear4CapitalFalse(){
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 2, "year", 100, 0, false, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear5CapitalFalse(){
        DepositCalculator DepositCalculator = new DepositCalculator(1000000000, 50, "year", 100, 0, false, LocalDate.of(2024, 1,1), "day");
        DepositCalculator.calculate();
    ...
    void typeYear6CapitalFalse(){
        DepositCalculator DepositCalculator = new DepositCalculator(10000, 3, "year", 6, 0, false, LocalDate.of(2024, 3,25), "day");
        DepositCalculator.calculate();
